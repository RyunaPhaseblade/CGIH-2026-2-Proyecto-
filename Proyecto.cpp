...
float posZJake;
float rotJake;
float movPiernas; // Controla la oscilación de piernas y brazos
...
// =================================================================
// ALGORITMO DE ANIMACIÓN COMPLEJA: Rieles de Tren (Path Following)
// =================================================================
...
int main()
{
	...
	*/
	...
	trenPosX = 80.0f;       // Inicia en la Vía 4
	trenPosZ = -120.0f;     // Alineado a la vía X
	trenRotY = -90.0f;       // Rotación inicial mirando hacia adelante
...
// ==========================================
	...
	// Cerca de la línea 60 de tu Proyecto.cpp
	float posXJake = 0.0f;
	float posZJake = 0.0f;
	float rotJake = 0.0f;
	...
	while (!mainWindow.getShouldClose())
	{
		...
		if (tipoCamara == 1) { // TERCERA PERSONA
			...
			if (abs(camFront.x) > 0.001f || abs(camFront.z) > 0.001f) {
				...
				walkForward = glm::vec3(0.0f, 0.0f, -1.0f); // Dirección segura por defecto
			}
			...
			// Tu cámara jala su posición basada en PersonajeMain
...
// =======================================================
		...
		vias_M.RenderModel();
		// ==========================================
			// ANIMACIÓN AUTOMÁTICA DEL TREN
			// ==========================================
		avanceTren += 1.0f * deltaTime;         // Velocidad del tren
		rotLlantasTren += 5.0f * deltaTime;    // Rotación de las llantas

		// Si recorre más de 450 unidades, lo regresamos al inicio de la vía
		if (avanceTren > 450.0f) {
			avanceTren = 0.0f;
		}

		// Variables temporales para recibir los cálculos
		float tPosX, tPosZ, tRotY;

		// =======================================================
		// 1. CABINA 
		// =======================================================
		CalcularPosicionTren(avanceTren, tPosX, tPosZ, tRotY); // Cálculo matemático
		...
		// =======================================================
		// 2. VAGÓN 1 (Ocupa la posición que tenía la cabina hace 8 unidades)
		// =======================================================
		...
		// =======================================================
		// 3. VAGÓN 2 (Ocupa la posición de hace 14 unidades)
		// =======================================================
		...
		// =======================================================
		// 4. VAGÓN 3 (Ocupa la posición de hace 20 unidades)
		// =======================================================
		...
		// ==========================================
		// ANIMACIÓN AUTOMÁTICA DEL TREN (Con Curva)
		// ==========================================
		// ==========================================
		// ANIMACIÓN AUTOMÁTICA DEL TREN (Con Curva)
		// ==========================================
		...
		// NOTA: Le cambié el "-" por un "+" para que las llantas también giren hacia adelante. 
		// Si notas que ahora las llantas patinan de reversa, solo regrésalo a "-=".
